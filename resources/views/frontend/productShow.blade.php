...
<head>
  ...
  <title>Inmobiliaria producto</title>
  ...
  <div class="container-fluid slidertotal">
    <div class="row">
      ...
      padding-left: 0;">
        ...
        @endforeach --}}
        {{-- <img src="img/featured_property_large-1110x623.jpg" alt="" style="height: 500px; width:100%;"> --}}
      ...
      <div class="col-6">
        <div class="row">
          ...
          padding-left: 0;">
            <a href="#" class="hero-cta">
              {{-- <img src="img/interior41.jpg" alt="" style="height: 250px; width:100%; padding:0px;"> --}}
        ...
        padding-left: 0;">
            <a href="#" class="hero-cta">
              {{-- <img src="img/full_background-1110x623.jpeg" alt="" style="height: 250px; width:100%;"> --}}
    ...
    padding-left: 0;">
            <a href="#" class="hero-cta">
              ...
              <div>
                ...
                {{-- <img src="img/interior42.jpg" alt="" style="height: 250px; width:100%; " /> --}}
