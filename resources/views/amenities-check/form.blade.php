<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group mb-2">
            ...
            {{ Form::select('amenities_id', $amenities->pluck('name', 'id'), $amenitiesCheck->amenities_id, ['class' => 'form-control' . ($errors->has('amenities_id') ? ' is-invalid' : ''), 'placeholder' => 'categoria']) }}
