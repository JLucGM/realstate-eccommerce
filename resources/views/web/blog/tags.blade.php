...
<section class="bg-texture    mb-5 py-5">
    <div class="container">
        ...
        <h3 class="text-center text-warning text-card ">{{$tag->name}}</h3>
            ...
            <div class="col-md-4 my-5 mx-50 ">
                <div class="col">
                    <div class="card shadow shadow-lg bg-transparen ">
                        <img src="{{ asset('img/posts/'.$post->img) }}" style="width: 100%; height:350px ;" class="card-img-top"
                            alt="{{$post->name}}">
                        <div class="card-body ">
                            ...
                            <div class="row justify-content-end">
                                <a href="{{ route('blog.show',$post) }}" class="col-3 button mx-3">ver</a>
                            </div>
                        </div>
                    </div>
                </div>
