                ...
                <div id="checkboxTable">
                    ...
                    <div class="card">
                        <form action="{{ route('fidel.store') }}" method="post">
                            ...
                            <h2>Monto<br><br>
                                <input class="form-control" type="text" name="monto" value="" placeholder="monto" Required>
                            </h2>
                             <h2>Puntos<br><br>
                                <input class="form-control" type="text" name="points" value="" placeholder="Puntos" Required>
                            </h2> 
                             <h2>Productos<br><br>
