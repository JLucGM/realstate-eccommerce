            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        ...
                        <input class="form-control {{ ($errors->has('name') ? ' is-invalid' : '') }}" type="text" name="name" value="" placeholder="Titulo de propiedad" >
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input class="form-control {{ ($errors->has('price') ? ' is-invalid' : '') }}" type="number" name="price" value="" placeholder="Precio" >
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control {{ ($errors->has('description') ? ' is-invalid' : '') }}" type="text" name="description" value="" placeholder="Descripción" ></textarea>
                        {!! $errors->first('description', '<div class="invalid-feedback">:message</div>') !!}
                    </div>
                    
                    <div class="col-12">
                        <label class="form-label">Notas del cliente</label>
                        <textarea class="form-control {{ ($errors->has('details') ? ' is-invalid' : '') }}" type="text" name="details" value="" placeholder="Notas del cliente" ></textarea>
                ...
                <div class="row">
                    <div class="col-12 col-md-4">
                        ...
                        <input class="form-control {{ ($errors->has('dormitorios') ? ' is-invalid' : '') }}" type="number" name="dormitorios" value="" placeholder="Dormitorios" >
                        {!! $errors->first('dormitorios', '<div class="invalid-feedback">:message</div>') !!}
                    </div>
                    
                    <div class="col-12 col-md-4">
                        <label class="form-label">Ambientes</label>
                        <input class="form-control {{ ($errors->has('ambientes') ? ' is-invalid' : '') }}" type="number" name="ambientes" value="" placeholder="Ambientes" >
                        {!! $errors->first('ambientes', '<div class="invalid-feedback">:message</div>') !!}
                    </div>
                    
                    <div class="col-12 col-md-4">
                        <label class="form-label">Baños</label>
                        <input class="form-control {{ ($errors->has('toilet') ? ' is-invalid' : '') }}" type="number" name="toilet" value="" placeholder="Baños" >
                ...
                <div class="row">
                    <div class="col-12 col-md-4">
                        ...
                        <input class="form-control {{ ($errors->has('metrosCuadradosT') ? ' is-invalid' : '') }}" type="number" name="metrosCuadradosT" value="" placeholder="M2 Totales" >
                        {!! $errors->first('metrosCuadradosT', '<div class="invalid-feedback">:message</div>') !!}
                    </div>
                    <div class="col-12 col-md-4">
                        <label class="form-label">M2 Cubiertos</label>
                        <input class="form-control {{ ($errors->has('metrosCuadradosC') ? ' is-invalid' : '') }}" type="number" name="metrosCuadradosC" value="" placeholder="M2 Cubiertos" >
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="estrenar" id="yes" value="1" >
                ...
                <div class="row">
                    <div class="col-12 col-md-4">
                        ...
                        <input class="form-control {{ ($errors->has('expensas') ? ' is-invalid' : '') }}" type="number" name="expensas" value="" placeholder="Expensas" >
                        {!! $errors->first('expensas', '<div class="invalid-feedback">:message</div>') !!}
                    </div>
                    
                    <div class="col-12 col-md-4">
                        <label class="form-label">Cocheras</label>
                        <input class="form-control {{ ($errors->has('cocheras') ? ' is-invalid' : '') }}" type="number" name="cocheras" value="" placeholder="Cocheras" >
                ...
                <div class="row mt-2">
                    <div class="col-12 col-md-6">
                        ...
                        <input class="form-control {{ ($errors->has('latitud') ? ' is-invalid' : '') }}" type="text" id="latitud" name="latitud" value="" placeholder="Latitud" >
                        {!! $errors->first('latitud', '<div class="invalid-feedback">:message</div>') !!}
                    </div>
                    <div class="col-12 col-md-6">
                        <label class="form-label">Longitud</label>
                        <input class="form-control {{ ($errors->has('longitud') ? ' is-invalid' : '') }}" type="text" id="longitud" name="longitud" value="" placeholder="Longitud" >
                ...
                <div class="buscador my-2">
                    ...
                    <input class="form-control {{ ($errors->has('direccion') ? ' is-invalid' : '') }}" type="text" name="direccion" id="direccion" value="" placeholder="Ingresar direccion">
